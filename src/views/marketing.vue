<template>
   <div class="w-11/12 xl:w-2/3 lg:w-2/3 md:w-2/3 mx-auto sm:mb-10 mb-16 pt-14">
   ...
   <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3 px-16">
        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div class="container px-6 py-10 mx-auto">
                <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white"> Product <span class="text-blue-500">development</span></h1>
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2">
                    <div class="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-medium text-gray-700 capitalize dark:text-white">Business analysis</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">
                                    Here we define the scope of your business and come up with a ferm business concept model, we also conduct an enterprise SWOT analysis. 
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-medium text-gray-700 capitalize dark:text-white">product designing</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">
                                    As we are very pedantic with visuals, our design team will work hand in hand with you to come up with a product that is presentable and well scalable.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-medium text-gray-700 capitalize dark:text-white">cost efficient strategy</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">
                                Based on the full-fledged business analysis, we define and prioritize only those functions that really matter and spend less time and money on the development of the product                                 </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-medium text-gray-700 capitalize dark:text-white">accelerated product marketing</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">
                                Reach the market in a blink with a fully-functioning prototype and find out whether your concept is viable and is in demand, and will build an active online environment to boost your product.                                </p>
                            </div>
                        </div>
                    </div>
                </div>
