                ...
                <div class="flex flex-wrap items-center pb-12">
                    <div class="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
                        <div class="py-2 text-color">
                            ...
                            <h2 class="font-medium text-gray-700 text-x1 lg:leading-7 md:leading-10 f-f-r py-4 md:py-8">We help you update your system software and hardware components to the latest and most efficient industry standard. We provide the market with software bundles and packages which are fully customizable to preferance. We have also heavily invested in providing new designs of UX & UI for web platforms like dashboads and apps.</h2>
