<template>
  <header class="bg-gray-900 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3">
    ...
    <nav id="nav" :class="isOpen ? 'block' : 'hidden'" class="px-3 pt-2 pb-4 sm:flex sm:p-0">
      ...
      <router-link to="/software" class="mt-1 block px-2 py-1 text-purple-400 font-semibold rounded hover:bg-gray-800 sm:mt-0 sm:ml-2">Software</router-link>
      <router-link to="/web" class="mt-1 block px-2 py-1 text-purple-400 font-semibold rounded hover:bg-gray-800 sm:mt-0 sm:ml-2">Web</router-link>
